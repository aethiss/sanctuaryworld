...
// Videos
const introVideo =
  'https://d3a5h34gwy5glx.cloudfront.net/assets/media/agegate-background-ultrawide-intro.9e333f400749237bc0aa377cb3664c90.mp4'
const loopVideo =
  'https://d3a5h34gwy5glx.cloudfront.net/assets/media/agegate-background-ultrawide.2ffb2a2abafb092f3fe1b01e2de1c8d3.mp4'

const styles = {
  homeContainer: {
    backgroundImage:
      'url("/images/background/desktop-home-background-ultrawide.jpg")',
...
const HomePageDesktop = ({ battletag }) => {
  ...
  return (
    <div style={styles.homeContainer}>
      {clientReady && (
        <video
          key={videoEnd ? loopVideo : introVideo}
          autoPlay
          muted
          width='100%'
